  ...
  return (
    <div id='contact' className='w-full bg-four flex justify-center'>
        <div className="w-full m-4 py-14 md:w-1/2 lg:m-24">
            ...
            <button type="submit" className="flex flex-row gap-12 rounded-full m-4 bg-primary disabled:hover:bg-light enabled:hover:bg-sky-400  p-3 text-xl text-white" disabled={state.submitting}>
                Submit
            </button>
